                        ...
                        <div class="panel-body">
                            <div >
                               ...
                               <div class="col-md-12">
                                ...
                                <div class="col-md-9">
                                    <input type="submit" class="btn btn-info" value="ADD" style="margin-top:4%;margin-left: 40%;" id="sub"/>
                                </div> 
                                </div>
                                </div> 
                               </form:form>
...
$(document).ready(function(){
	...
	newTextBoxDiv.after()('<input type="text"  style="margin-top:1%;margin-bottom:2%;width: 500.5px;" name="article' + counter + '" id="article' + counter + '" value=""  placeholder="Quotes Message" ></input>');
