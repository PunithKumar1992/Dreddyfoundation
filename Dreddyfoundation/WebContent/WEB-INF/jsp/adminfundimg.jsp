...
<section class="wrapper">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadminfundimg"   modelAttribute="fundimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
	...
	<section class="wrapper">
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">Fund Raising Images</h2>
		<div class="gallery-grids">
				
				<div class="gallery-top-grids">
					
					<c:forEach var="fundimglist" items="${adminfunimg}">
					<c:url var="deleteadminfundimg" value="deleteadminfundimg">
					<c:param name="gallery_id" value="${fundimglist.galleryimg_id}"></c:param>
					<c:param name="gallery_img" value="${fundimglist.gallery_image}"></c:param>
					</c:url>
					<c:if test="${fundimglist.galleryimg_type=='fundraise'}">
					<div class="col-sm-4 gallery-grids-left">
					<a href="${deleteadminfundimg}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a>
				
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${fundimglist.gallery_image}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${fundimglist.gallery_image}" alt="" height="260px"/>
