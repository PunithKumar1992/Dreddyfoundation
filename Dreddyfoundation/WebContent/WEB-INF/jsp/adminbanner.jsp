...
<section id="main-content">
            ...
            <div class="col-md-12" id="bann">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div>
                               <form:form action="saveadminbanner" enctype="multipart/form-data"  method="post" modelAttribute="adminbanner" onsubmit="return FormValidation();" onchange="return FormValidation();">
  ...
  <div class="panel panel-default">
    ...
    <c:url var="adminbannerdel" value="adminbannerdelete">
    ...
    <c:url var="banedit" value="adminbanneredit">
    <c:param name="banner_image" value="${adminbanlist.banner_image}"></c:param>
    <c:param name="banner_id" value="${adminbanlist.banner_id}"></c:param>
            ...
            reader.onload = function (e) {
                ...
                image.onload = function () {
                    ...
                    if (height == 780 && width == 1920) {
                    	...
                    	{
                    	 alert("Height and Width must not exceed 1920px & 780px.");
