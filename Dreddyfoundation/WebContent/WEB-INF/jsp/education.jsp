...
<html >
    ...
    <title>Dayananda foundation</title>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="section-title">
                        <h2>Educational <span>events</span></h2>
                   ...
                   <div class="sermons-wrapper">
                        <div class="col-md-4 col-sm-6">
                            <div class="single-post-wrapper">
                                <div class="post-thumb event-post-bg-20">
                                </div>
                                <div class="post-inner">
                                    ...
                                    <div class="port-body">
                                        <p>Responding to the needs of children and women in India DAYANAND FOUNDATION is a registered non-government organization, which works purely on a nonprofit basis.</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-post-wrapper">
                                <div class="post-thumb event-post-bg-21">
                                </div>
                                <div class="post-inner">
                                    <a href="#">
                                        <h3></h3>
                                    ...
                                    <div class="port-body">
                                        <p>Thank you all for being part of a wonderful cause today. Dayananda foundation celebrates its 6th anniversary today reaching a new milestone of 7500+ adopted students.</p>
                                        <a href="#" class="boxed-btn">Read More</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-post-wrapper">
                                <div class="post-thumb event-post-bg-22">
                                </div>
                                <div class="post-inner">
                                    <a href="#">
                                        <h3></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-post-wrapper">
                                <div class="post-thumb event-post-bg-23">
                                </div>
                                <div class="post-inner">
                                    <a href="#">
                                        <h3></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-post-wrapper">
                                <div class="post-thumb event-post-bg-24">
                                </div>
                                <div class="post-inner">
                                    <a href="#">
                                        <h3></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-post-wrapper">
                                <div class="post-thumb event-post-bg-25">
                                </div>
                                <div class="post-inner">
                                    <a href="#">
                                        <h3></h3>
...
<br><br><br>
  <div class="about-box-sections-1">

           <div class="row">
  <div class="col-md-3">
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   <iframe src="https://www.youtube.com/embed/LaSv_INZJTM" allowfullscreen="" frameborder="0" style="width:100%;"></iframe>
  </div>
  <div class="col-md-3">
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   <iframe src="https://www.youtube.com/embed/hJZIRTvmSBY" allowfullscreen="" frameborder="0" style="width:100%;"></iframe>
  </div>
  <div class="col-md-3">
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   <iframe src="https://www.youtube.com/embed/1U2LXJ-dnn0" allowfullscreen="" frameborder="0" style="width:100%;"></iframe>
  </div>
  <div class="col-md-3">
    <a href=""><span class="fa fa-trash-o"></span></a>
    <a href=""><span class="fa fa-plus"></span></a>
    <iframe src="https://www.youtube.com/embed/aABVU4NH5iU" allowfullscreen="" frameborder="0" style="width:100%;"></iframe>
  </div><br>
  </div>
 <br><br>
   <div class="row">
   ...
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   <iframe src="https://www.youtube.com/embed/zJ8MGAJtKaY" allowfullscreen="" frameborder="0" style="width:100%;"></iframe>
    </div>
    <div class="col-md-3">
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   ...
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   <iframe src="https://www.youtube.com/embed/pq8vp79fSCk" allowfullscreen="" frameborder="0" style="width:100%;"></iframe>
    </div>
    <div class="col-md-3">
   <a href=""><span class="fa fa-trash-o"></span></a>
   <a href=""><span class="fa fa-plus"></span></a>
   <iframe src="https://www.youtube.com/embed/hJZIRTvmSBY" allowfullscreen="" frameborder="0" style="width:100%;"></iframe> 
    ...
    <br><br><br>
               ...
               <div class="col-md-4">
                   ...
                   <p>The idea of this project is to provide 3 years of high school education i.e. 8th, 9th, 10th and after which technical education based on the requirement of the more than 500 affiliated industries to ensure employment.</p>
                   <p> This program is helping them to get free education and employment which leads in strengthening the economic growth of an individual, their family and the country make them self-sustainable.</p>
               </div>
               <div class="col-md-4">
                   <h4>We Established in<span>2008</span></h4>
                   <p>The idea of this project is to provide 3 years of high school education i.e. 8th, 9th, 10th and after which technical education based on the requirement of the more than 500 affiliated industries to ensure employment. </p>
                   <p>This program is helping them to get free education and employment which leads in strengthening the economic growth of an individual, their family and the country make them self-sustainable.</p>
               </div>
               <div class="col-md-4">
                   <h4>Our <span> Goal</span></h4>
                   <p>The idea of this project is to provide 3 years of high school education i.e. 8th, 9th, 10th and after which technical education based on the requirement of the more than 500 affiliated industries to ensure employment. </p>
                  <p> This program is helping them to get free education and employment which leads in strengthening the economic growth of an individual, their family and the country make them self-sustainable.</p>
               </div>
           </div>
