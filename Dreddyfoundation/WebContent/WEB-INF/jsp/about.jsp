           ...
           <div class="row">
              <div class="col-md-6"> 
                   <div class="about-us-image"> 
                     <h3>know about<span> Dayanandafoundation?</span></h3>
                     <p>Dayananda Reddy the founder of Dayananda foundation who was also a member of a legislative council of Karnataka, representative of the local bodies of Bangalore urban district which covers 28 assemblies.</p>
<p>Dayananda Reddy was born to B.N Thimma Reddy and Gowramma in 1963 at Anekal, Bengaluru urban district and finished his education in government school from a very young age he used to believe and still believe in “knowledge is wealth” and showed his ability to lead his organizational capability right from the tender age.</p> 
            <p>His first focus was on education and employment issues of the youth, as he found a huge disparity in the education system of rural and urban students. He also noted the following statistics of employment and employability skills of Indian youth, so this leads to Dayananda foundation in 2010. </p>
                    ...
                    <div class="right-latest-news-wrapper">
                        <div class="single-latest-news-list">
                            <div class="post-thumb">
                                <img src="images/225 X 225 1.jpg" alt="latest news image">
                            </div>
...
<p> The foundation of every state is the education of its youth.</p>
               ...
               <div class="single-latest-news-list">
                            <div class="post-thumb">
                                <img src="images/225 X 225.jpg" alt="latest news image">
                            </div>
                            <div class="single-news-wrapper">
                                <div class="latest-news-list-content">
                                    <h4>Foundation</h4>
                                    <p>I think the foundation of everything in my life is wonder.</p>
    ...
    <section class="count-sectoin count-section-bg" 
       style="background:url(assets/img/bg-img-2.jpg);">
        <div class="container">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-counter-box">
                        <div class="counter-wrapper">
                            ...
                            <h4>Saved Life</h4>
                            <span class="count-separator"></span>
                            <span class="count-number"><strong>5500</strong></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                                ...
                                <div class="team-details-wrapper text-center">
                                    <div class="team-table-cell">
                                        <div class="team-inner-top">
                                            ...
                                            <p>The aim of education is the knowledge, not of facts, but of values.
</p>
                                        </div>
                                        <div class="team-social-btn">
                                            <a href="#"><i class="icofont icofont-social-facebook"></i></a>
