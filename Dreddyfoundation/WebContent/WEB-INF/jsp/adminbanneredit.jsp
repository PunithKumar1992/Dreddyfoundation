            ...
            <div class="col-md-12" id="bann">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div>
                               <form:form action="saveadminbanneredit" enctype="multipart/form-data"  method="post" modelAttribute="editadminbanner" onsubmit="return FormValidation();" onchange="return FormValidation();">
