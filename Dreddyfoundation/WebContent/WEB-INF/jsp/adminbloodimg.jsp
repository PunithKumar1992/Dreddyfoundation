...
<section class="wrapper">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            BloodDanation Images
                        </header>
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadminblooddonationimg"   modelAttribute="blooddonationimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
	...
	<section class="wrapper">
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">BloodDonation Images</h2>
		<div class="gallery-grids">
				
				<div class="gallery-top-grids">
					
					<c:forEach var="bloodimglist" items="${adminblodimg}">
					<c:url var="deleteadminbloodimg" value="deleteadminbloodimg">
					<c:param name="gallery_id" value="${bloodimglist.galleryimg_id}"></c:param>
					<c:param name="gallery_img" value="${bloodimglist.gallery_image}"></c:param>
					</c:url>
					<c:if test="${bloodimglist.galleryimg_type=='blooddonation'}">
					<div class="col-sm-4 gallery-grids-left">
					<a href="${deleteadminbloodimg}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a>
				
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${bloodimglist.gallery_image}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${bloodimglist.gallery_image}" alt="" height="260px"/>
