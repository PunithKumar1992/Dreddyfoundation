...
<section id="main-content">
	<section class="wrapper">
			...
			<div class="row">
			<div class="col-md-3">
			<a href="adminbanner"><img src="adminimages/banner_icon.png" alt=""></a>
			</div>
			<div class="col-md-3">
			<a href="admingallery"><img src="adminimages/gallery_icon.png" alt=""></a>
			</div>
			<div class="col-md-3">
			<a href="adminvideo"><img src="adminimages/videos_icon.png" alt=""></a>
			</div>
			<div class="col-md-3">
			<a href="adminarticle"><img src="adminimages/blog_icon.png" alt=""></a>
			</div>
			<div class="col-md-3">
			<a href="adminquotes"><img src="adminimages/quotes.png" alt=""></a>
			</div>
			<div class="col-md-3">
			<a href="adminpionners"><img src="adminimages/feedback_icon.png" alt=""></a>
			</div>
