            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                               <form:form  method="post" action="saveadminarticle" enctype="multipart/form-d
                               ata" modelAttribute="adminarticle">
                               
                               <div class="col-md-9">
                             
                                 <label style="margin-left:5%;">Select the Article Type</label><form:select path="article_type" required="true" style="margin-left:3.5%;margin-bottom:2%;">
                               	 <form:option value="select" selected="selected" disabled="true">Select Option</form:option>
                                 <form:option value="socialarticle">socialarticle</form:option>
                                 <form:option value="educationalarticle">educationalarticle</form:option>
                               </form:select>
                               </div>
