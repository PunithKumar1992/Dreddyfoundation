...
<section class="wrapper">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadminmedicalimg"   modelAttribute="medicalimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
	...
	<section class="wrapper">
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">Medicalcamp Images</h2>
		<div class="gallery-grids">
				
				<div class="gallery-top-grids">
					
					<c:forEach var="medicalimglist" items="${adminmedicalimg}">
					<c:url var="deleteadminmedicalimg" value="deleteadminmedicalimg">
					<c:param name="gallery_id" value="${medicalimglist.galleryimg_id}"></c:param>
					<c:param name="gallery_img" value="${medicalimglist.gallery_image}"></c:param>
					</c:url>
					<c:if test="${medicalimglist.galleryimg_type=='medicalcamp'}">
					<div class="col-sm-4 gallery-grids-left">
					<a href="${deleteadminmedicalimg}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a>
				
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${medicalimglist.gallery_image}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${medicalimglist.gallery_image}" alt="" height="260px"/>
