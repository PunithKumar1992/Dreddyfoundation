...
public class AdminRecoveryDaoimpl implements AdminRecoveryDao {
	...
	public int checkMailidtosend(String email) {
		...
		int flag=0;
		Query query =session.createQuery("from Dreddyfadminregiestration where admin_email=:mail");
...
Session session =factory.getCurrentSession();
		...
		String result = (String)session.createCriteria(Dreddyfadminregiestration.class)
